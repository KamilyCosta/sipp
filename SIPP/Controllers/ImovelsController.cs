...
namespace SIPP.Controllers
{
    public class ImovelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ImovelId,Endereco,cidade,QntDormitorios,QntGarragem,Tamanho,TamanhoAreaContuida,MetodoPagamento,Valor")] Imovel imovel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ImovelId,Endereco,cidade,QntDormitorios,QntGarragem,Tamanho,TamanhoAreaContuida,MetodoPagamento,Valor")] Imovel imovel)
        {
